...
def libArdListMain():
    l = []
    l.append({'name': translation(31030), 'mode': 'libArdListVideosSinglePage',
              'url': 'http://www.ardmediathek.de/tv/Neueste-Videos/mehr?documentId=21282466&rss=true', '_type': 'dir'})
    l.append({'name': translation(31031), 'mode': 'libArdListVideosSinglePage',
              'url': 'http://www.ardmediathek.de/tv/Meistabgerufene-Videos/mehr?documentId=21282514&m23644322=quelle.tv&rss=true', '_type': 'dir'})
    #l.append({'name':translation(31032), 'mode':'libArdListLetters', '_type':'dir'})
    l.append({'name': translation(31032),
              'mode': 'libArdListShows', '_type': 'dir'})
    l.append({'name': translation(31033),
              'mode': 'libArdListChannel', '_type': 'dir'})
    l.append({'name': translation(31034), 'mode': 'libArdListVideos',
              'url': 'http://www.ardmediathek.de/appdata/servlet/tv/Rubriken/mehr?documentId=21282550&json', '_type': 'dir'})
    l.append({'name': translation(31035), 'mode': 'libArdListVideos',
              'url': 'http://www.ardmediathek.de/appdata/servlet/tv/Themen/mehr?documentId=21301810&json', '_type': 'dir'})
...
def libArdListChannelDateVideos():
    if False:
        url = 'http://www.ardmediathek.de/tv/sendungVerpasst?tag=' + \
            params['datum']+'&kanal='+channels[params['channel']]
        return libardlisting.listDate(url)
    url = 'http://www.ardmediathek.de/appdata/servlet/tv/sendungVerpasst?json&kanal=' + \
        channels[params['channel']]+'&tag='+params['datum']
